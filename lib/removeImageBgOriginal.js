...
/**
 * Remove the background by scanning from the top-left color and removing pixels
 * within a certain color distance. We raised the default tolerance to 50.
 */
async function removeImageBg(filePath, tolerance = 50) {
  // Read the image
